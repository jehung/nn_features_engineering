...
def reduction_clustering(X, y, k, problem):
    ...
    return clustering.evaluate_kmeans(X_ica, y, problem)
    ...
    parameters = {
        'NN__hidden_layer_sizes': [(n,), (n, n, n), (n, n, n, n, n), (n, n, n, n, n, n, n),
                                   ...
                                   (n, int(0.7 * n), int(0.7 * n), int(0.7 * n), int(0.7 * n), int(0.7 * n),
                                    int(0.7 * n)), ],
        'ica__n_components': [2, 3, 4, 5, 6, 7, 8, 9]}
...
if __name__ == '__main__':
    ...
    #reduction_clustering(train, target, 5, 'FreddiMac')
    ...
    #reduction_clustering(train, target, 5, 'BloodDonation')
